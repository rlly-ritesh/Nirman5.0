    ...
    <div className="w-full pt-10 flex flex-col justify-start items-start">
      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="text-gray-400 text-sm font-medium leading-[18px] font-sans">
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-end items-start gap-2">
              <div className="text-gray-400 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-white transition-colors">
                Features
              </div>
              <div className="text-gray-400 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-white transition-colors">
                Pricing
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              <div className="self-stretch text-gray-400 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-white transition-colors">
                Terms of use
              </div>
              <div className="self-stretch text-gray-400 text-sm font-normal leading-5 font-sans cursor-pointer hover:text-white transition-colors">
                API Reference
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <div className="w-full h-full relative">
            {Array.from({ length: 400 }).map((_, i) => (
              <div
                key={i}
                className="absolute w-[300px] h-16 border border-white/10"
                style={{
                  left: `${i * 300 - 600}px`,
                  top: "-120px",
